...
void solaris::Linker::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  if (!Args.hasArg(options::OPT_nostdlib, options::OPT_nostartfiles,
    ...
    CmdArgs.push_back(Args.MakeArgString(GetFilePath(values_X)));
    ...
    CmdArgs.push_back(
        Args.MakeArgString(GetFilePath(values_xpg)));
    CmdArgs.push_back(
  ...
  if (!Args.hasArg(options::OPT_nostdlib, options::OPT_nodefaultlibs,
    ...
    if (NeedsSanitizerDeps) {
      ...
      // in Illumos.
      const SanitizerArgs &SA = getSanitizerArgs(Args);
  ...
  if (!Args.hasArg(options::OPT_nostdlib, options::OPT_nostartfiles,
    ...
    CmdArgs.push_back(
        Args.MakeArgString(GetFilePath("crtn.o")));
  }

...
public:
  ...
  virtual bool
  checkCFProtectionReturnSupported() const override {
    return true;
  };

  virtual bool
  checkCFProtectionBranchSupported() const override {
    return true;
  };
...
//    case llvm::CallingConv::X86Pascal:
    case llvm::CallingConv::IntelOclBicc:
...
public:
  ...
  CallingConvCheckResult checkCallingConvention(llvm::CallingConv::ID CC) const override {
    ...
    return CC == llvm::CallingConv::C ? CCCR_OK : CCCR_Warning;
  }
...
public:
  ...
  CallingConvCheckResult checkCallingConvention(llvm::CallingConv::ID CC) const override {
    ...
    case llvm::CallingConv::PreserveMost:
    case llvm::CallingConv::PreserveAll:
    case llvm::CallingConv::X86_64SysV:
    case llvm::CallingConv::Swift:
    case llvm::CallingConv::SwiftAsync:
    case llvm::CallingConv::X86_RegCall:
    case llvm::CallingConv::OpenCLKernel:

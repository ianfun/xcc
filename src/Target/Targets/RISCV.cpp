...
ArrayRef<Builtin::Info> RISCVTargetInfo::getTargetBuiltins() const {
  return llvm::makeArrayRef(BuiltinInfo, RISCV::LastTSBuiltin -
...
bool RISCVTargetInfo::initFeatureMap(
  ...
  return TargetInfo::initFeatureMap(Features, CPU,
...
static StringRef computeDefaultABIFromArch(const llvm::RISCVISAInfo &ISAInfo) {
...
bool RISCVTargetInfo::handleTargetFeatures(std::vector<std::string> &Features) {
  ...
  if (ABI.empty())
    ABI = computeDefaultABIFromArch(*ISAInfo).str();

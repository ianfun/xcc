...
522:                                              ; preds = %504
  ...
  %524 = call i32 (ptr, ...) @printf(ptr @.cstr.28, i64 %523)
  ret i64 -1
...
170:                                              ; preds = %161
  ...
  %172 = call i32 (ptr, ...) @printf(ptr @.cstr.36, i64 %171)
  ret i32 -1
...
183:                                              ; preds = %173
  ...
  %185 = call i32 (ptr, ...) @printf(ptr @.cstr.37, i64 %184)
  ret i32 -1
...
200:                                              ; preds = %186
  %201 = call i32 (ptr, ...) @printf(ptr @.cstr.38)
  ret i32 -1

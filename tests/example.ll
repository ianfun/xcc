...
140:                                              ; preds = %125
  ...
  %142 = call i32 (ptr, ...) @printf(ptr @7, i64 %141)
  call void @exit(i32 -1)
  br label %143
...
206:                                              ; preds = %191
  ...
  %208 = call i32 (ptr, ...) @printf(ptr @8, i64 %207)
  call void @exit(i32 -1)
  br label %209
...
272:                                              ; preds = %264
  ...
  %274 = call i32 (ptr, ...) @printf(ptr @9, i64 %273)
  call void @exit(i32 -1)
  br label %275
...
304:                                              ; preds = %297
  ...
  %306 = call i32 (ptr, ...) @printf(ptr @10, i64 %305)
  call void @exit(i32 -1)
  br label %307
...
403:                                              ; preds = %393
  ...
  %405 = call i32 (ptr, ...) @printf(ptr @11, i64 %404)
  call void @exit(i32 -1)
  br label %406
...
435:                                              ; preds = %377
  ...
  %437 = call i32 (ptr, ...) @printf(ptr @12, i64 %436)
  call void @exit(i32 -1)
  br label %438
...
470:                                              ; preds = %464
  ...
  %472 = call i32 (ptr, ...) @printf(ptr @13, i64 %471)
  call void @exit(i32 -1)
  br label %473
...
498:                                              ; preds = %488
  ...
  %500 = call i32 (ptr, ...) @printf(ptr @14, i64 %499)
  call void @exit(i32 -1)
  br label %501
...
792:                                              ; preds = %782
  ...
  %794 = call i32 (ptr, ...) @printf(ptr @15, i64 %793)
  call void @exit(i32 -1)
  br label %795
...
868:                                              ; preds = %863
  ...
  %870 = call i32 (ptr, ...) @printf(ptr @16, i64 %869)
  call void @exit(i32 -1)
  br label %871
...
885:                                              ; preds = %844
  ...
  %890 = call i32 (ptr, ...) @printf(ptr @17, i64 %888, i64 %889)
  call void @exit(i32 -1)
  br label %891
...
27:                                               ; preds = %22
  ...
  %29 = call i32 (ptr, ...) @printf(ptr @22, i64 %28)
  call void @exit(i32 -1)
  br label %30
...
37:                                               ; preds = %30
  ...
  %39 = call i32 (ptr, ...) @printf(ptr @23, i64 %38)
  call void @exit(i32 -1)
  br label %40
